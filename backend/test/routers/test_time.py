...
def setup_target_for_test(client, get_headers):
    data = {"date": "2024-05-05", "target_time": 5}
    client.post("/target", json=data, headers=get_headers)


def setup_actual_for_test(client, get_headers):
...
def test_register_target_with_expired_token(client, get_headers):
...
def test_register_actual(client, get_headers):
    setup_target_for_test(client, get_headers)
    data = {"actual_time": 5, "date": "2024-05-05"}
...
def test_register_actual_after_finish(client, get_headers):
    ...
    setup_target_for_test(client, get_headers)
    setup_actual_for_test(client, get_headers)
